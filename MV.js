...
////mine
function triangleSide(p1,p2,a,b){
	xs1 = math.cross(b-a, p1-a);
	xs2 = math.cross(b-a, p2-a);
	if (math.dot(xs1,xs2) >= 0){
		return true;
	}
	else{
		return false;
...
if(triangleSide(pointer,smallBlackTriangle1[0],smallBlackTriangle1[1],smallBlackTriangle1[2]) && triangleSide(smallBlackTriangle1[1],smallBlackTriangle1[0],smallBlackTriangle1[2]) && triangleSide(smallBlackTriangle1[2],smallBlackTriangle1[0],smallBlackTriangle1[1])){
}
